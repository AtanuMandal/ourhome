...
public static class InfrastructureDependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // Resolves the single Cosmos database name every repository shares.
        static string DbName(IServiceProvider sp) =>
            sp.GetRequiredService<IOptions<InfrastructureSettings>>().Value.CosmosDbDatabaseName;

        // Repositories — societies, apartments, users
        ...
        // Repositories — amenities, complaints, notices, visitors
        ...
        // Repositories — shifts, staff roster, attendance
        ...
        // Repositories — maintenance billing, fees, vendor expenses
        ...
        // Repositories — competitions, rewards, service marketplace
        ...
        // Repositories — outbox, push/mobile notification registrations
